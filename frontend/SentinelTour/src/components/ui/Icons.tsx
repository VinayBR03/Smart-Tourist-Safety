...
export const Icon = {
  ...
  Calendar: ({ size = 24, color = '#fff', strokeWidth = 2 }: IconProps) => {
    return (
      <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
  ...
  ArrowLeft: ({ size = 24, color = '#fff', strokeWidth = 2 }: IconProps) => (
    <Svg width={size} height={size} viewBox="0 0 25 19" fill="none">
      <Line x1="25" y1="12" x2="5" y2="12" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round"/>
      <Polyline points="12 19 5 12 12 5" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round"/>
    </Svg>
  ),

  ArrowRight : ({ size = 24, color = '#fff', strokeWidth = 2 }: IconProps) => (
    <Svg width={size} height={size} viewBox="0 0 21 21" fill="none">
      <Line x1="1" y1="12" x2="19" y2="12" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
