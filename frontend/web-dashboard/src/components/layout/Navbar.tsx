...
export function Navbar({
  ...
  // On mobile: show X when drawer is open, hamburger when closed
  // On desktop: always show hamburger (sidebar collapses, never a drawer)
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          aria-label={showClose ? 'Close sidebar' : collapsed ? 'Expand sidebar' : 'Collapse sidebar'}
          className={[
        ...
        >
          {showClose ? (
            /* X — mobile drawer is open */
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
            </svg>
          ) : (
            /* Hamburger — desktop (always) + mobile (closed) */
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
