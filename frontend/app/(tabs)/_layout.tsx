  ...
  return (
    <Tabs
      screenOptions={{
        headerShown: false,
        tabBarStyle: {
          backgroundColor: C.surface,      // ← reactive
          borderTopColor:  C.border,        // ← reactive
          borderTopWidth: 1,
    ...
    >
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <TabIcon focused={focused}
              icon={<Icon.Home size={24} color={focused ? C.primary : C.textMuted} />}
            />
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <TabIcon focused={focused}
              icon={<Icon.Map size={24} color={focused ? C.primary : C.textMuted} />}
            />
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <TabIcon focused={focused}
              icon={<Icon.HeartPulse size={24} color={focused ? C.heartRate : C.textMuted} />}
            />
          ),
        }}
      />
